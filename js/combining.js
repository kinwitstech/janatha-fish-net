...
function addSwitcher() {
	...
	e.indexOf("xhtml-rtl") > -1
		? ((i = e.replace("xhtml-rtl", "xhtml")), (a = e))
		: ((a = e.replace("xhtml", "xhtml-rtl")), (i = e));
	var r =
		...
		addSwitcher(),
			...
			jQuery(".skin-2").on("click", function () {
				return (
					...
					jQuery(".logo-center .logo-c").attr(
						"src",
...
function setThemePanel() {
	jQuery.each(themeOption, function (e, i) {
		if (
			((themeOptionItemValue = getCookie(i + "_value")),
...
function setThemeLogo(e) {
	...
	"" != i &&
		(jQuery(".logo-white img").attr("src", i),
...
function getCookie(e) {
	for (
		var i = e + "=", a = decodeURIComponent(document.cookie).split(";"), r = 0;
		r < a.length;
		r++
	) {
